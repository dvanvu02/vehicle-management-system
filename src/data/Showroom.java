...
public class Showroom extends ArrayList<Vehicle> {
	...
	public void storeDataToFile() {
		File file = new File("C:\\Users\\Vanvu\\Desktop\\(CS)IT.(Software-Engineering)\\Base-Core-Foundation\\(Object-Oriented-Programming)OOP\\OOP\\(OOP-with-Java-lab)projects\\P1.VehicleManagementSystemvehicles.txt");
		try {
