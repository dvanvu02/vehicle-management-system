...
public class Utils {
	...
	public static int getAnInteger(String inputMsg, String errorMsg,
		...
		do {
			...
			} catch (NumberFormatException e) {System.out.println(errorMsg);}
		} while (true);
	}
        ...
        while (true) {
            try {
                ...
                if (number > 0 && number <= currentYear)
                    ...
                    System.out.println("The yeaf of manufacture must be greater than 0 and less than or equal to the current year, please re-enter!");
